...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publisher.description'
        db.add_column('events_publisher', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Publisher.description'
        db.delete_column('events_publisher', 'description')
