...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demand.convention'
        db.add_column('events_demand', 'convention',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['events.Convention']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Demand.convention'
        db.delete_column('events_demand', 'convention_id')
